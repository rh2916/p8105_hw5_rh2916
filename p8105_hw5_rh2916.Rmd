...
Baltimore_proportion_of_unsolved_homicides = prop.test(Baltimore_unsolved_homicides[ ,1], Baltimore_homicide[ ,1]) %>% 
broom::tidy() 

Baltimore_proportion_of_unsolved_homicides %>% pull(estimate) 
Baltimore_proportion_of_unsolved_homicides %>% pull(conf.low)
Baltimore_proportion_of_unsolved_homicides %>% pull(conf.high)
```
